...
- **Учител (admin)** — създава, редактира и изтрива задачи; вижда всички потребители ([demo account](#row163) `admin@demo.com` pass:demo123)
- **Ученик (user)** — решава задачи, качва файлове, коментира, участва в дискусии ([demo account](#row163) `admin@demo.com` pass:demo123)
